...
#define SLIC3R_APP_FULL_NAME "Qidi Admin Studio"
#define GCODEVIEWER_APP_NAME "Qidi Admin Studio Preview"
#define GCODEVIEWER_APP_KEY  "QidiAdminStudioPreview"
#define GCODEVIEWER_BUILD_ID std::string("Qidi Admin Studio Preview-") + std::string(SLIC3R_VERSION) + std::string("-RC")
